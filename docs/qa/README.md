...
| 14 | [P14](passes/P14-markdown-import.md) | Markdown (Scabard) export/import round-trip | 45 min |
| 15 | [P15](passes/P15-effect-text-landmines.md) | Three `data.js` cells that must not be "corrected" | 15 min |

Roughly 9–11 hours for a complete sweep across about 15 sessions. Passes 6–10 are
