...
| 7 | Compartment | 4 square cm storage area in body. +6 to Subterfuge to hide things within. | 4 square cm storage area in body. +6d Subterfuge to hide things within. | — | |
| 8 | Covert Synthskin | Color changing skin, tactical. Reroll 1s and 2s on Shadow tests. +1 to dodge. Immune to cameras. 1 Impact Armor | Color changing skin, tactical. Reroll 1s and 2s on Shadow tests. +1 Dodge. Immune to cameras. +1 Impact Armor. | — | |
...
| 40 | Rocket Boots | +8d to jumps and Athletics. Reroll 1s and 2s on jumps. Grants thrust compensation. | +8d Athletics for jumps. Reroll 1s and 2s on jumps. Grants thrust compensation. | — | |
...
| 73 | Sound Filter | +1 to Observation tests. Allows for selective sound filtering. | +1d Observation. Allows for selective sound filtering. | `sense: Selective hearing` | |
...
| 102 | Synaptic Enhancers | +2 to Reaction and Intelligence-and maximums. Speeds up brain processing and reaction times. | +2 Reaction (also raises the maximum). +2 Intelligence (also raises the maximum). Speeds up brain processing and reaction times. | — | |
...
| 153 | Nu-Tek TVSkin | Similar to viewscreen, but can display HD video. Requires Arwin or Chipjack and internal storage. | Requires an Arwin or Chipjack, and internal storage. Similar to a viewscreen, but can display HD video. | — | **UNCLEAR** — "Requires Arwin or Chipjack and internal storage" doesn't make clear whether "and internal storage" is required alongside either option, or only alongside Chipjack; the Description has the identical ambiguity ("Requires a communicator or chipjack and internal storage"), so preserved rather than resolved |
...
| 10 | Racoon | Can mount medium or large for cover (-2). +2 on all dodge tests | Can mount a medium or large creature for cover (-2). +2d Dodge. | — | **UNCLEAR**: "mount ... for cover (-2)" doesn't say what the -2 applies to (attacker's roll? the mount's?) or what "mount" means mechanically here. Ambiguity kept from the original. |
...
| 16 | Enchanting | Enthrall spell at ZP. | Grants the Enthrall spell (at ZP). | — | **UNCLEAR**: "at ZP" is undefined (a ZP cost? a ZP-gated unlock?) — kept as vague as the original. |
...
| 49 | Polypedal Legs 4 | -1m level and +2 Athletics dice | -1 Move level. +2d Athletics. | — | **UNCLEAR**: "level" (a movement-tier concept?) isn't defined anywhere in this packet; kept as vague as the original rather than inventing a meaning. |
| 50 | Polypedal Legs 6 | -2m level and +4 Athletics dice | -2 Move levels. +4d Athletics. | — | **UNCLEAR**: same "level" ambiguity as Polypedal Legs 4. |
| 51 | Polypedal Legs 8 | -3m level and +6 Athletics dice | -3 Move levels. +6d Athletics. | — | **UNCLEAR**: same "level" ambiguity as Polypedal Legs 4. |
...
| 10 | Weirding Way | +2m base movement | +2m Movement (base). | `movement +2` | |
...
| 13 | Gun-Kata | Treated as armed in melee. Can SS in melee. | Treated as armed in melee. Can SS in melee. | — | **UNCLEAR**: "SS" isn't defined anywhere in the packet (likely a firearms fire-mode abbreviation); left unexpanded rather than guessing at its meaning. |
...
| 21 | Gun-Kata | Melee attacks w/n 2m penalized by Firearms skill | Melee attacks within 2m are penalized by Firearms skill. | — | **UNCLEAR**: whose Firearms skill and how large the penalty is aren't specified by the original; ambiguity preserved. |
...
| 8 | Eyes of the Raptor | +2 bonus dice to Firearms | +2d Firearms. | — | |
| 9 | Might of the Bear | +2 bonus dice to Unarmed Combat | +2d Unarmed Combat. | — | |
| 10 | Sting of the Scorpion | +2 bonus dice to Melee Weapons | +2d Melee Weapons. | — | |
...
| 17 | Hidden Presence | +2 bonus on Shadow and Subterfuge | +2d Shadow and Subterfuge. | — | |
...
| # | Name | Original | Proposed | Engine | Notes |
|---|---|---|---|---|---|
| 1 | Range Extension | Extends hacking range to 15 meters (7.5") | Hacking range 15m (7.5"). | — | |
| 2 | Wide Area Protocols | Extends hacking range to 20 meters (10") | Hacking range 20m (10"). | — | |
...
| 3 | Electronic Countermeasures | Drones/Vehicles -1d to hit | Drones/Vehicles: -1d to hit. | — | **UNCLEAR**: doesn't say whose drones/vehicles (enemy, presumably, given the name) — ambiguity kept from the original rather than assumed. |
...
| 3 | Cram | Pills or hypopatch. Sleeplessness and +2d to Focus tests for 12 hrs. Can chain up to 4. | Pills or hypopatch. Sleeplessness and +2d Focus Pool for 12 hours. Can chain up to 4. | `pool Focus+2` | |
...
| 7 | Kamakazi | Nasal inhaler. +2 Finesse and Brawn for 15 minutes. Can double effect at 3 Dependence. | Nasal inhaler. +2d Finesse/Brawn Pool for 15 minutes. Can double effect at 3 Dependence. | `pool Finesse+2, Brawn+2` | TYPO: item name "Kamakazi" is very likely a misspelling of "Kamikaze" — flagged only; the Name column is not rewritten here (renaming orphans saved characters per the style guide). |
...
| 2 | Extended Magazine | +20% ammunition | +20% ammunition. | — | |
...
| 28 | Enthrall | Tgt is Charmed, trusting caster as friend. Duration is Force in months(Int<5)/weeks(Int<10)/days(Int<15)/hours(Int>15). | Target is charmed, trusting caster as a friend. Duration: Force months (Int<5), weeks (Int<10), days (Int<15), or hours (Int>15). | — | CHECK — Effect's brackets (`Int<15` days, `Int>15` hours) leave exactly Int=15 undefined; Description assigns Int=15 to the hours bucket ("fifteen and above"). Flagging the boundary gap, not resolving it. |
...
| 13 | Decoy 1 | Choose target IRL, they gain +1d dodge bonus | Choose a target within range of influence. They gain +Rating dice to dodge tests. | — | UNCLEAR: "IRL" resolved from Description as "in range of influence" — out of context it reads as "in real life." |
| 14 | Decoy 2 | Choose target IRL, they gain +2d dodge bonus | Choose a target within range of influence. They gain +Rating dice to dodge tests. | — | UNCLEAR: "IRL" resolved from Description as "in range of influence" — out of context it reads as "in real life." |
| 15 | Decoy 3 | Choose target IRL, they gain +3d dodge bonus | Choose a target within range of influence. They gain +Rating dice to dodge tests. | — | UNCLEAR: "IRL" resolved from Description as "in range of influence" — out of context it reads as "in real life." |
| 16 | Decoy 4 | Choose target IRL, they gain +4d dodge bonus | Choose a target within range of influence. They gain +Rating dice to dodge tests. | — | UNCLEAR: "IRL" resolved from Description as "in range of influence" — out of context it reads as "in real life." |
| 17 | Decoy 5 | Choose target IRL, they gain +5d dodge bonus | Choose a target within range of influence. They gain +Rating dice to dodge tests. | — | UNCLEAR: "IRL" resolved from Description as "in range of influence" — out of context it reads as "in real life." |
| 18 | Decoy 6 | Choose target IRL, they gain +6d dodge bonus | Choose a target within range of influence. They gain +Rating dice to dodge tests. | — | UNCLEAR: "IRL" resolved from Description as "in range of influence" — out of context it reads as "in real life." |
...
| 116 | Shadow Protocols 1 | Lowers Alert by 1 per success. Can be loaded into I/O | Reduces the Alert level by 1 per Net Success. Can be loaded into the I/O stream. | — | UNCLEAR: Description states loading it into the I/O stream instead reduces *all* alert increases by the program's Rating — a second, passive mode the Effect text never actually states the magnitude of. |
| 117 | Shadow Protocols 2 | Lowers Alert by 1 per success. Can be loaded into I/O | Reduces the Alert level by 1 per Net Success. Can be loaded into the I/O stream. | — | UNCLEAR: Description states loading it into the I/O stream instead reduces *all* alert increases by the program's Rating — a second, passive mode the Effect text never actually states the magnitude of. |
| 118 | Shadow Protocols 3 | Lowers Alert by 1 per success. Can be loaded into I/O | Reduces the Alert level by 1 per Net Success. Can be loaded into the I/O stream. | — | UNCLEAR: Description states loading it into the I/O stream instead reduces *all* alert increases by the program's Rating — a second, passive mode the Effect text never actually states the magnitude of. |
| 119 | Shadow Protocols 4 | Lowers Alert by 1 per success. Can be loaded into I/O | Reduces the Alert level by 1 per Net Success. Can be loaded into the I/O stream. | — | UNCLEAR: Description states loading it into the I/O stream instead reduces *all* alert increases by the program's Rating — a second, passive mode the Effect text never actually states the magnitude of. |
| 120 | Shadow Protocols 5 | Lowers Alert by 1 per success. Can be loaded into I/O | Reduces the Alert level by 1 per Net Success. Can be loaded into the I/O stream. | — | UNCLEAR: Description states loading it into the I/O stream instead reduces *all* alert increases by the program's Rating — a second, passive mode the Effect text never actually states the magnitude of. |
| 121 | Shadow Protocols 6 | Lowers Alert by 1 per success. Can be loaded into I/O | Reduces the Alert level by 1 per Net Success. Can be loaded into the I/O stream. | — | UNCLEAR: Description states loading it into the I/O stream instead reduces *all* alert increases by the program's Rating — a second, passive mode the Effect text never actually states the magnitude of. |
